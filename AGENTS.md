# fast-harness — Agent Instructions

This file embeds the fast-harness workflow and harness engineering principles for agents that use AGENTS.md (OpenAI Codex, and other compatible agents).
